...
function getConfigDir() {
    ...
    if (platform === 'win32') {
        configDir = path.join(os.homedir(), 'AppData', 'Roaming', 'salecoach-andy-demo-config');
    } else if (platform === 'darwin') {
        configDir = path.join(os.homedir(), 'Library', 'Application Support', 'salecoach-andy-demo-config');
    } else {
        configDir = path.join(os.homedir(), '.config', 'salecoach-andy-demo-config');
    }
